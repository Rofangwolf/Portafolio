    ...
    return (
        <div>
            <div className="flex pt-10 justify-between gap-10">
                <img src={mifoto} className="rounded-full" alt="Rodrigo" height="450" width="550" />
                <div className="bg-grey border border-black p-5">
                    ...
                    <h3 className="mt-10 text-xl text-justify">
                        Ingeniero Civil Electrónico titulado de la Pontificia Universidad Católica de Valparaíso y del bootcamp de programación Soy Henry.  Mi principal interes es seguir aumentando mis conocimientos sobre todo en lo que tenga que ver con programación, Internet of Things y Cloud Computing.</h3>

                    <div className="mt-8">
                        <h3 className="text-3xl mt-3">Con respecto a mis experiencias, lo resumiria de la siguiente manera:</h3>
                        <div >
